...
def main():
    ...
    # Load the CSV file
    df = pd.read_csv('congress_full/crec2023.csv')
    
    # Load config to get GloVe path
    with open('config_files/config_congress_full.json', 'r') as f:
        config = json.load(f)
    ...
    with open('congress_full/corpus.txt', 'w', encoding='utf-8') as f:
    ...
    # skip this next section if congress_full/doc2phrases.txt already exists
    if os.path.exists('congress_full/doc2phrases.txt'):
        ...
        with open('congress_full/doc2phrases.txt', 'w', encoding='utf-8') as f:
    ...
    with open('congress_full/topics.txt', 'w', encoding='utf-8') as f:
        for idx, topic in enumerate(policy_areas):
            f.write(f"{idx}\t{topic}\n")
    
    # Save topic_hier.txt
    with open('congress_full/topic_hier.txt', 'w', encoding='utf-8') as f:
    ...
    doc2phrases_map = {}
    with open('congress_full/doc2phrases.txt', 'r', encoding='utf-8') as f:
        for line in f:
    ...
    with open('congress_full/topic_triples.txt', 'w', encoding='utf-8') as f:
    ...
    save_vectors_word2vec_format('congress_full/topic_feats.txt', topic_vectors, 300)
    
    print("Preprocessing complete! Files have been created in the congress_full/ directory.")
